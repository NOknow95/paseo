  ...
  desktop: {
    ...
    updates: {
      status: {
        ...
        pending: "تتوفر نسخة جديدة.",
        pendingWithLastChecked: "تتوفر نسخة جديدة. آخر فحص في {{time}}.",
        pendingWithVersion: "تم العثور على تحديث: {{version}}.",
        pendingWithVersionAndLastChecked: "تم العثور على تحديث: {{version}}. آخر فحص في {{time}}.",
